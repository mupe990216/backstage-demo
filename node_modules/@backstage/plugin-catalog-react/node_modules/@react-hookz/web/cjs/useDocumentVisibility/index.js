...
function useDocumentVisibility(initializeWithValue = true) {
    ...
    (0, useEventListener_1.useEventListener)(const_1.isBrowser ? document : null, 'visibilitychange', () => setIsVisible(isDocumentVisible()));
    return isVisible;
}
